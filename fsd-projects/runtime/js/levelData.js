    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 500, y: groundY - 540, damage: -10, hitZone: 25, image: "img/drone.png", offsetX: -32.5, offsetY: -32.5, scale: 0.5, velocityX: 3.5, velocityY: 1, increaseScore: 300, stopEnemy: true},
          { type: "enemy", x: 2100, y: groundY - 100, damage: -10, hitZone: 25, image: "img/drone.png", offsetX: -32.5, offsetY: -32.5, scale: 0.5, velocityX: 3.5, velocityY: 1, increaseScore: 300, stopEnemy: true},
          { type: "enemy", x: 2500, y: groundY - 100, damage: -10, hitZone: 25, image: "img/drone.png", offsetX: -32.5, offsetY: -32.5, scale: 0.5, velocityX: 3.5, velocityY: 1, increaseScore: 300, stopEnemy: true},
          { type: "enemy", x: 2600, y: groundY - 100, damage: -10, hitZone: 25, image: "img/drone.png", offsetX: -32.5, offsetY: -32.5, scale: 0.5, velocityX: 3.5, velocityY: 1, increaseScore: 300, stopEnemy: true},
